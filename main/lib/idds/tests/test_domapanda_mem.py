...
def setup_workflow():
    ...
    work1 = DomaPanDAWork(executable='echo',
                          ...
                          task_name=taskN1.name, task_queue=None, task_site=panda_site, task_rss=3000,
    ...
    work2 = DomaPanDAWork(executable='echo',
                          ...
                          task_name=taskN2.name, task_queue=None, task_site=panda_site, task_rss=7000,
                          encode_command_line=True,
                          task_priority=881,
                          prodSourceLabel='managed',
                          task_log={"dataset": "PandaJob_#{pandaid}/",
    ...
    work3 = DomaPanDAWork(executable='echo',
                          ...
                          task_name=taskN3.name, task_queue=None, task_site=panda_site, task_rss=14000,
                          encode_command_line=True,
                          task_priority=781,
                          prodSourceLabel='managed',
                          task_log={"dataset": "PandaJob_#{pandaid}/",
    ...
    work4 = DomaPanDAWork(executable='echo',
                          ...
                          task_name=taskN4.name, task_queue=None, task_site=panda_site, task_rss=20000,
                          encode_command_line=True,
                          task_priority=981,
                          prodSourceLabel='managed',
                          task_log={"dataset": "PandaJob_#{pandaid}/",
    ...
    work5 = DomaPanDAWork(executable='echo',
                          ...
                          task_name=taskN5.name, task_queue=None, task_site=panda_site, task_rss=33000,
                          encode_command_line=True,
                          task_priority=981,
                          prodSourceLabel='managed',
                          task_log={"dataset": "PandaJob_#{pandaid}/",

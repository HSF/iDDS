...
@transactional_session
def update_contents_from_others_by_dep_id_pages(request_id=None, transform_id=None, page_size=1000, status_not_to_check=None, logger=None, session=None):
    """
    Update contents from others by content_dep_id
    ...
    return orm_contents.update_contents_from_others_by_dep_id_pages(request_id=request_id, transform_id=transform_id, page_size=page_size,
                                                                    logger=logger, status_not_to_check=status_not_to_check, session=session)


@transactional_session
def update_input_contents_by_dependency_pages(request_id=None, transform_id=None, page_size=500, batch_size=1000, logger=None,
    ...
    return orm_contents.update_input_contents_by_dependency_pages(request_id=request_id, transform_id=transform_id, page_size=page_size,
                                                                  batch_size=batch_size, terminated=terminated, logger=logger,

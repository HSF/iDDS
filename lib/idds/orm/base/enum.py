...
"""
handling sqlachelmy enum types.

Borrowed from:
https://github.com/rucio/rucio/blob/master/lib/rucio/db/sqla/enum.py
"""
...
from idds.common.exceptions import InvalidDatabaseType
...
class DeclEnumType(SchemaType, TypeDecorator):
    ...
    def process_bind_param(self, value, dialect):
        try:
            ...
            raise InvalidDatabaseType('Invalid value/type %s for %s' % (value, self.enum))

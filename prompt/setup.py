...
class CustomInstallCommand(install):
    ...
    def run(self):
        ...
        logger.info("idds-prompt installing")
...
class CustomBdistWheel(bdist_wheel):
    ...
    def finalize_options(self):
        ...
        logger.info("idds-prompt wheel installing")
        logger.info(f"self.distribution.packages: {self.distribution.packages}")
        included_packages = [
...
with io.open('lib/idds/prompt/version.py', "rt", encoding="utf8") as f:
...
requirements_files = ['tools/prompt/env/environment.yml']
